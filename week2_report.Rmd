...
```{r, echo=FALSE}
data.frame(terms=c("I love you", "I love dog", "I love cat"), count=c(10,6,4))
```
The Markov chains will be
```{r, echo=FALSE}
data.frame(current_state=c("I love","I love","I love"), next_state=c("you","dog","cat"), 
           probability=c("10/20","6/20","4/20"))
```
